...
const CaptainSignup = () => {
  ...
  const submitHandler = async (e) => {
    ...
    console.log('Submitting captain register', captainData, 'BASE=', BASE)
    try {
      const response = await axios.post(`${BASE}/captains/register`, captainData)
      console.log('Captain register response', response && response.status, response && response.data)
